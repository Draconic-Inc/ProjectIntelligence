 ...
 */
public class GuiProjectIntelligence_old extends ModularGuiScreen {
    public static GuiProjectIntelligence_old activeInstance = null;
    ...
    public GuiPartMenu_old guiMenu;
    public GuiPartPageList_old contentList;
    public GuiPartMDWindow_old contentWindow;
    ...
    public GuiProjectIntelligence_old() {
        GuiProjectIntelligence_old.activeInstance = this;
        new LanguageManager();
    }
    ...
    public void addElements(GuiElementManager manager) {
        ...
        guiMenu = new GuiPartMenu_old(this);
        contentList = new GuiPartPageList_old(this);
        contentWindow = new GuiPartMDWindow_old();
    ...
    public void reloadGui() {
        ...
        if (PIConfig.editMode()) {
            if (mc.player != null) {
                PIGuiHelper.updatePlayerInventory(mc.player);
            }
        }
        super.reloadGui();
    }
    ...
    public static GuiPartMenu_old getMenuPart() {
    ...
    public static GuiPartPageList_old getListPart() {
    ...
    public static GuiPartMDWindow_old getMDPart() {
