package com.brandon3055.projectintelligence.client.gui.moddata;
...
public class WikiDocManager {
    public static final ResourceLocation piDoc = new ResourceLocation(ProjectIntelligence.MOD_PREFIX + "projectintelligence.xml");
...
//            modDocsFolder = new File(PIConfig.editingRepoLoc);
//
...
//            }
//            throw new RuntimeException("//TODO check that edit target is valid and disable edit mode if it is not");
//        }
...
//            loadDocsFromDisk();
//        }
//        if (GuiPIMainWindow.activeInstance == null) {
//            return;
//        }
//        if (reloadTree && GuiPIMainWindow.activeInstance.wikiDataTree != null) {
//            GuiPIMainWindow.activeInstance.wikiDataTree.reloadData();
//        }
//        if (reloadGui && GuiPIMainWindow.activeInstance.contentList != null) {
//            GuiPIMainWindow.activeInstance.contentList.reloadList(); //TODO May need to reload other parts of the gui
//        }
    }
}
