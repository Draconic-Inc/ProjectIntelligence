...
public class StylePreset {
    ...
    public void apply() {
        PIConfig.NAV_WINDOW = this.NAV_WINDOW;
        PIConfig.CONTENT_WINDOW = this.CONTENT_WINDOW;
        PIConfig.MENU_BAR = this.MENU_BAR;
        PIConfig.NAV_TEXT = this.NAV_TEXT;
        PIConfig.TEXT_COLOUR = this.TEXT_2;
        PIConfig.save();
    }
